...
def test_voucher_image_thumb_uses_preview_cache(tmp_path, mock_app_client, mock_engine_for_api):
    ...
    mock_engine_for_api.image_service.ensure_preview_cache = AsyncMock(
    ...
    mock_engine_for_api.image_service.ensure_preview_cache.assert_awaited_once_with("proj1", str(source), max_width=800)

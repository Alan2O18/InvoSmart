...
```json
{
   ...
   "發票張數": { "pdfX": 473.5, "pdfY": 92, "fontSize": 16 },
   "支付日期": { "pdfX": 205, "pdfY": 767, "fontSize": 20 },
   "支付金額": { "pdfX": 314, "pdfY": 767, "fontSize": 20 }
}
```
...
| 發票張數 | 473.5 | 92 | 16 | |
| 支付日期 | 205 | 767 | 20 | 格式：`114/11/28` |
| 支付金額 | 314 | 767 | 20 | 格式：`4,607元整` |
